...
// Atom Storage Structure
typedef struct AtomStorage {
    unsigned long long carbon;    // Carbon atoms count
    unsigned long long oxygen;    // Oxygen atoms count
    unsigned long long hydrogen;  // Hydrogen atoms count
} AtomStorage;
